...
export const resetSelectedCourse = createAction('[Courses] Reset Selected Course');
...
export const deleteCourseCancelled = createAction('[Courses] Delete Course Cancelled');
